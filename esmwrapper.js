import fuzzball from './fuzzball.js';

export const distance = fuzzball.distance;
export const ratio = fuzzball.ratio;
export const partial_ratio = fuzzball.partial_ratio;
export const token_set_ratio = fuzzball.token_set_ratio;
export const token_sort_ratio = fuzzball.token_sort_ratio;
export const partial_token_set_ratio = fuzzball.partial_token_set_ratio;
export const partial_token_sort_ratio = fuzzball.partial_token_sort_ratio;
export const token_similarity_sort_ratio = fuzzball.token_similarity_sort_ratio;
export const partial_token_similarity_sort_ratio = fuzzball.partial_token_similarity_sort_ratio;
export const WRatio = fuzzball.WRatio;
