var se,pe="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:{},he={exports:{}},de=Math.floor,ge=Math.max,ve=Math.min,_calculateRatio=function(se,pe){return pe?2*se/pe:1},_arrayCmp=function(se,pe){var he,de,ge,ye,_e,be;for(_e=[se.length,pe.length],he=ye=0,be=ve(de=_e[0],ge=_e[1]);0<=be?ye<be:ye>be;he=0<=be?++ye:--ye){if(se[he]<pe[he])return-1;if(se[he]>pe[he])return 1}return de-ge},_has=function(se,pe){return Object.prototype.hasOwnProperty.call(se,pe)},ye=function(){function SequenceMatcher(se,pe,he,de){this.isjunk=se,null==pe&&(pe=""),null==he&&(he=""),this.autojunk=null==de||de,this.a=this.b=null,this.setSeqs(pe,he)}return SequenceMatcher.prototype.setSeqs=function(se,pe){return this.setSeq1(se),this.setSeq2(pe)},SequenceMatcher.prototype.setSeq1=function(se){if(se!==this.a)return this.a=se,this.matchingBlocks=this.opcodes=null},SequenceMatcher.prototype.setSeq2=function(se){if(se!==this.b)return this.b=se,this.matchingBlocks=this.opcodes=null,this.fullbcount=null,this._chainB()},SequenceMatcher.prototype._chainB=function(){var se,pe,he,ge,ve,ye,_e,be,me,xe,we,je,ke,Ee;for(se=this.b,this.b2j=pe={},ge=xe=0,je=se.length;xe<je;ge=++xe)he=se[ge],(_has(pe,he)?pe[he]:pe[he]=[]).push(ge);if(ye={},ve=this.isjunk)for(we=0,ke=(Ee=Object.keys(pe)).length;we<ke;we++)ve(he=Ee[we])&&(ye[he]=!0,delete pe[he]);if(me={},_e=se.length,this.autojunk&&_e>=200)for(he in be=de(_e/100)+1,pe)pe[he].length>be&&(me[he]=!0,delete pe[he]);return this.isbjunk=function(se){return _has(ye,se)},this.isbpopular=function(se){return _has(me,se)}},SequenceMatcher.prototype.findLongestMatch=function(se,pe,he,de){var ge,ve,ye,_e,be,me,xe,we,je,ke,Ee,Ae,Se,Oe,Re,Ce,Ie,ze,$e,Me,Ne;for(ge=(Ce=[this.a,this.b,this.b2j,this.isbjunk])[0],ve=Ce[1],ye=Ce[2],we=Ce[3],_e=(Ie=[se,he,0])[0],be=Ie[1],me=Ie[2],ke={},xe=Se=se;se<=pe?Se<pe:Se>pe;xe=se<=pe?++Se:--Se){for(Ae={},Oe=0,Re=(ze=_has(ye,ge[xe])?ye[ge[xe]]:[]).length;Oe<Re;Oe++)if(!((je=ze[Oe])<he)){if(je>=de)break;(Ee=Ae[je]=(ke[je-1]||0)+1)>me&&(_e=($e=[xe-Ee+1,je-Ee+1,Ee])[0],be=$e[1],me=$e[2])}ke=Ae}for(;_e>se&&be>he&&!we(ve[be-1])&&ge[_e-1]===ve[be-1];)_e=(Me=[_e-1,be-1,me+1])[0],be=Me[1],me=Me[2];for(;_e+me<pe&&be+me<de&&!we(ve[be+me])&&ge[_e+me]===ve[be+me];)me++;for(;_e>se&&be>he&&we(ve[be-1])&&ge[_e-1]===ve[be-1];)_e=(Ne=[_e-1,be-1,me+1])[0],be=Ne[1],me=Ne[2];for(;_e+me<pe&&be+me<de&&we(ve[be+me])&&ge[_e+me]===ve[be+me];)me++;return[_e,be,me]},SequenceMatcher.prototype.getMatchingBlocks=function(){var se,pe,he,de,ge,ve,ye,_e,be,me,xe,we,je,ke,Ee,Ae,Se,Oe,Re,Ce,Ie,ze,$e,Me,Ne,Pe;if(this.matchingBlocks)return this.matchingBlocks;for(Oe=[[0,ke=(ze=[this.a.length,this.b.length])[0],0,Ee=ze[1]]],Ae=[];Oe.length;)pe=($e=Oe.pop())[0],se=$e[1],de=$e[2],he=$e[3],ge=(Me=Re=this.findLongestMatch(pe,se,de,he))[0],_e=Me[1],(xe=Me[2])&&(Ae.push(Re),pe<ge&&de<_e&&Oe.push([pe,ge,de,_e]),ge+xe<se&&_e+xe<he&&Oe.push([ge+xe,se,_e+xe,he]));for(Ae.sort(_arrayCmp),ve=be=we=0,Se=[],Ce=0,Ie=Ae.length;Ce<Ie;Ce++)ye=(Ne=Ae[Ce])[0],me=Ne[1],je=Ne[2],ve+we===ye&&be+we===me?we+=je:(we&&Se.push([ve,be,we]),ve=(Pe=[ye,me,je])[0],be=Pe[1],we=Pe[2]);return we&&Se.push([ve,be,we]),Se.push([ke,Ee,0]),this.matchingBlocks=Se},SequenceMatcher.prototype.getOpcodes=function(){var se,pe,he,de,ge,ve,ye,_e,be,me,xe,we;if(this.opcodes)return this.opcodes;for(de=ge=0,this.opcodes=pe=[],_e=0,be=(me=this.getMatchingBlocks()).length;_e<be;_e++)se=(xe=me[_e])[0],he=xe[1],ve=xe[2],ye="",de<se&&ge<he?ye="replace":de<se?ye="delete":ge<he&&(ye="insert"),ye&&pe.push([ye,de,se,ge,he]),de=(we=[se+ve,he+ve])[0],ge=we[1],ve&&pe.push(["equal",se,de,he,ge]);return pe},SequenceMatcher.prototype.getGroupedOpcodes=function(se){var pe,he,de,ye,_e,be,me,xe,we,je,ke,Ee,Ae,Se,Oe;for(null==se&&(se=3),(pe=this.getOpcodes()).length||(pe=[["equal",0,1,0,1]]),"equal"===pe[0][0]&&(we=(Ee=pe[0])[0],ye=Ee[1],_e=Ee[2],be=Ee[3],me=Ee[4],pe[0]=[we,ge(ye,_e-se),_e,ge(be,me-se),me]),"equal"===pe[pe.length-1][0]&&(we=(Ae=pe[pe.length-1])[0],ye=Ae[1],_e=Ae[2],be=Ae[3],me=Ae[4],pe[pe.length-1]=[we,ye,ve(_e,ye+se),be,ve(me,be+se)]),xe=se+se,de=[],he=[],je=0,ke=pe.length;je<ke;je++)we=(Se=pe[je])[0],ye=Se[1],_e=Se[2],be=Se[3],me=Se[4],"equal"===we&&_e-ye>xe&&(he.push([we,ye,ve(_e,ye+se),be,ve(me,be+se)]),de.push(he),he=[],ye=(Oe=[ge(ye,_e-se),ge(be,me-se)])[0],be=Oe[1]),he.push([we,ye,_e,be,me]);return!he.length||1===he.length&&"equal"===he[0][0]||de.push(he),de},SequenceMatcher.prototype.ratio=function(){var se,pe,he,de;for(se=0,pe=0,he=(de=this.getMatchingBlocks()).length;pe<he;pe++)se+=de[pe][2];return _calculateRatio(se,this.a.length+this.b.length)},SequenceMatcher.prototype.quickRatio=function(){var se,pe,he,de,ge,ve,ye,_e,be,me,xe;if(!this.fullbcount)for(this.fullbcount=he={},ve=0,_e=(me=this.b).length;ve<_e;ve++)he[pe=me[ve]]=(he[pe]||0)+1;for(he=this.fullbcount,se={},de=0,ye=0,be=(xe=this.a).length;ye<be;ye++)pe=xe[ye],ge=_has(se,pe)?se[pe]:he[pe]||0,se[pe]=ge-1,ge>0&&de++;return _calculateRatio(de,this.a.length+this.b.length)},SequenceMatcher.prototype.realQuickRatio=function(){var se,pe,he;return he=[this.a.length,this.b.length],_calculateRatio(ve(se=he[0],pe=he[1]),se+pe)},SequenceMatcher}(),_e={exports:{}};se=_e,function(){var pe,he,de,ge,ve,ye,_e,be,me,xe,we,je,ke,Ee,Ae;de=Math.floor,xe=Math.min,he=function(se,pe){return se<pe?-1:se>pe?1:0},me=function(se,pe,ge,ve,ye){var _e;if(null==ge&&(ge=0),null==ye&&(ye=he),ge<0)throw new Error("lo must be non-negative");for(null==ve&&(ve=se.length);ge<ve;)ye(pe,se[_e=de((ge+ve)/2)])<0?ve=_e:ge=_e+1;return[].splice.apply(se,[ge,ge-ge].concat(pe)),pe},ye=function(se,pe,de){return null==de&&(de=he),se.push(pe),Ee(se,0,se.length-1,de)},ve=function(se,pe){var de,ge;return null==pe&&(pe=he),de=se.pop(),se.length?(ge=se[0],se[0]=de,Ae(se,0,pe)):ge=de,ge},be=function(se,pe,de){var ge;return null==de&&(de=he),ge=se[0],se[0]=pe,Ae(se,0,de),ge},_e=function(se,pe,de){var ge;return null==de&&(de=he),se.length&&de(se[0],pe)<0&&(pe=(ge=[se[0],pe])[0],se[0]=ge[1],Ae(se,0,de)),pe},ge=function(se,pe){var ge,ve,ye,_e,be,me;for(null==pe&&(pe=he),be=[],ve=0,ye=(_e=function(){me=[];for(var pe=0,he=de(se.length/2);0<=he?pe<he:pe>he;0<=he?pe++:pe--)me.push(pe);return me}.apply(this).reverse()).length;ve<ye;ve++)ge=_e[ve],be.push(Ae(se,ge,pe));return be},ke=function(se,pe,de){var ge;if(null==de&&(de=he),-1!==(ge=se.indexOf(pe)))return Ee(se,0,ge,de),Ae(se,ge,de)},we=function(se,pe,de){var ve,ye,be,me,xe;if(null==de&&(de=he),!(ye=se.slice(0,pe)).length)return ye;for(ge(ye,de),be=0,me=(xe=se.slice(pe)).length;be<me;be++)ve=xe[be],_e(ye,ve,de);return ye.sort(de).reverse()},je=function(se,pe,de){var ye,_e,be,we,je,ke,Ee,Ae,Se;if(null==de&&(de=he),10*pe<=se.length){if(!(be=se.slice(0,pe).sort(de)).length)return be;for(_e=be[be.length-1],we=0,ke=(Ee=se.slice(pe)).length;we<ke;we++)de(ye=Ee[we],_e)<0&&(me(be,ye,0,null,de),be.pop(),_e=be[be.length-1]);return be}for(ge(se,de),Se=[],je=0,Ae=xe(pe,se.length);0<=Ae?je<Ae:je>Ae;0<=Ae?++je:--je)Se.push(ve(se,de));return Se},Ee=function(se,pe,de,ge){var ve,ye,_e;for(null==ge&&(ge=he),ve=se[de];de>pe&&ge(ve,ye=se[_e=de-1>>1])<0;)se[de]=ye,de=_e;return se[de]=ve},Ae=function(se,pe,de){var ge,ve,ye,_e,be;for(null==de&&(de=he),ve=se.length,be=pe,ye=se[pe],ge=2*pe+1;ge<ve;)(_e=ge+1)<ve&&!(de(se[ge],se[_e])<0)&&(ge=_e),se[pe]=se[ge],ge=2*(pe=ge)+1;return se[pe]=ye,Ee(se,be,pe,de)},pe=function(){function Heap(se){this.cmp=null!=se?se:he,this.nodes=[]}return Heap.push=ye,Heap.pop=ve,Heap.replace=be,Heap.pushpop=_e,Heap.heapify=ge,Heap.updateItem=ke,Heap.nlargest=we,Heap.nsmallest=je,Heap.prototype.push=function(se){return ye(this.nodes,se,this.cmp)},Heap.prototype.pop=function(){return ve(this.nodes,this.cmp)},Heap.prototype.peek=function(){return this.nodes[0]},Heap.prototype.contains=function(se){return-1!==this.nodes.indexOf(se)},Heap.prototype.replace=function(se){return be(this.nodes,se,this.cmp)},Heap.prototype.pushpop=function(se){return _e(this.nodes,se,this.cmp)},Heap.prototype.heapify=function(){return ge(this.nodes,this.cmp)},Heap.prototype.updateItem=function(se){return ke(this.nodes,se,this.cmp)},Heap.prototype.clear=function(){return this.nodes=[]},Heap.prototype.empty=function(){return 0===this.nodes.length},Heap.prototype.size=function(){return this.nodes.length},Heap.prototype.clone=function(){var se;return(se=new Heap).nodes=this.nodes.slice(0),se},Heap.prototype.toArray=function(){return this.nodes.slice(0)},Heap.prototype.insert=Heap.prototype.push,Heap.prototype.top=Heap.prototype.peek,Heap.prototype.front=Heap.prototype.peek,Heap.prototype.has=Heap.prototype.contains,Heap.prototype.copy=Heap.prototype.clone,Heap}(),se.exports=pe}.call(pe);var be,me,xe,we=_e.exports,je={exports:{}};
/**
 * @license
