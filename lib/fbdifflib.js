...
let floor = Math.floor, max = Math.max, min = Math.min;

let _calculateRatio = function (matches, length) {
    if (length) {
...
let _has = function (obj, key) {
    return Object.prototype.hasOwnProperty.call(obj, key);
};

let _any = function (items) {
    var item, _i, _len;
