...
export function extract(query: any, choices: any, opts?: any): ExtractResults;
export function extractAsync(query: any, choices: any, opts?: any, callback?: (err: any, results?: ExtractResults) => void): void;
