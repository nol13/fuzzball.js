...
const FilterableTable = ({ filter, onFilter, fullProcVal, onFullProcCheck, wildcards, onWildcard, dataset, onDataset, enteredData }) => {
    let input;
    let input2;
    let input3;
    let input4;
            ...
            <label>
               Select dataset:&nbsp;
                <select ref={node => { input4 = node; }} value={dataset}
                    onChange={() => handleDataSetChange(input4.value)}>
